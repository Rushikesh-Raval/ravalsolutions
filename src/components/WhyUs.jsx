...
const WhyUs = () => {
  const points = [
    {
      title: 'US-Based Communication',
      desc: 'No more waiting 24 hours for an email response. We operate in US time zones and speak your language.',
    },
    {
      ...
      <div className="flex flex-col lg:flex-row gap-16 items-center">
        ...
        <div className="lg:w-1/2">
          <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-8 leading-tight">
            Why Successful US Businesses <br className="hidden md:block" /> Raval Solutions
          </h2>
